...
- The frame-mAP evaluation is following the [Superevent](https://github.com/piergiaj/super-events-cvpr18/blob/master/apmeter.py) and [action-conditional metrics](https://github.com/ptirupat/MLAD/blob/main/src/cooccur_metric.py) is following the MLAD.
